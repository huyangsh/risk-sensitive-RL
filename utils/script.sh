...
python ./NN_train.py --env Toy-1000 --beta 0.01 --tau 1.0 --dim_emb 1000 --num_train 5000 --freq_eval 50 --thres_eval 0.01 --batch_size 10000 --disp_V_opt --disp_V_pi --disp_policy
